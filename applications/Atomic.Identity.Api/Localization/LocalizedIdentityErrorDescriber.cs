...
{
    private readonly IStringLocalizer<AtomicIdentityResource> _localizer;

    public LocalizedIdentityErrorDescriber(IStringLocalizer<AtomicIdentityResource> localizer)
    {
